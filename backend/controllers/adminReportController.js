  ...
  try {
    ...
    sales.forEach((s) => {
      salesSheet.addRow({
        ...
        customerPhone: s.customerPhone || s.customerContact || "-",
    ...
    purchases.forEach((p) => {
      purchaseSheet.addRow({
        ...
        shopId: p.user?.shopId || "-",
        supplierName: p.supplierName || "-",
        supplierPhone: p.supplierPhone || p.supplierContact || "-",
    ...
    saleBorrows.forEach((b) => {
      borrowSheet.addRow({
        ...
        name: b.customerName || "-",
        contact: b.customerPhone || b.customerContact || "-",
        shopId: b.user?.shopId || "-",
        recordedBy: b.user?.name || "-",
    ...
    purchaseBorrows.forEach((b) => {
      borrowSheet.addRow({
        ...
        itemName: b.item?.name || "-",
        name: b.supplierName || "-",
        contact: b.supplierPhone || b.supplierContact || "-",
        shopId: b.user?.shopId || "-",
        recordedBy: b.user?.name || "-",
        quantity: b.quantity || 0,
        borrowAmount: b.borrowAmount || 0,
